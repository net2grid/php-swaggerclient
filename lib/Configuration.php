 ...
 *
 * Handles gamification business logic
 *
 * OpenAPI spec version: 1.0-snapshot
 * Contact: martijn@net2grid.com
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://gamification.n2g-rwe.net/api';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    OpenAPI Spec Version: 1.0-snapshot' . PHP_EOL;
